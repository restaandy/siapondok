<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.2.6.503f785.css');
    ...
    if ($autoload_javascript) {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.2.6.503f785' . $minify_or_not . '.js');
    } else {
        $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-no-autoload-v2.2.6.503f785' . $minify_or_not . '.js');
    }
